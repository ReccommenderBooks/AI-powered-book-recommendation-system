...
SECRET_KEY = 'django-insecure-mx98*er481ns@w=&8z+mww+94wix#@$(csz%)c3^b)4(6&*60v'
...
# Media files (if you'll allow book covers)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Custom settings for your recommendation system
